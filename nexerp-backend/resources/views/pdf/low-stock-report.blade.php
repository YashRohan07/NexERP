...
<body>
    ...
    <div class="section">
        ...
        <table class="summary-table">
            <tr>
                ...
                <td class="summary-label">Out of Stock Count</td>
                <td>{{ $summary['out_of_stock_count'] }}</td>
            </tr>
            <tr>
                <td class="summary-label">Low Stock Inventory Value</td>
                <td colspan="3">{{ $summary['low_stock_inventory_value'] }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        @else
            <div class="empty">No low stock products found for the selected filters.</div>
        @endif
    </div>
</body>
</html>