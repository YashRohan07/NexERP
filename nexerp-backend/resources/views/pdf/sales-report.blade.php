...
<body>
    ...
    <div class="section">
        ...
        <table class="summary-table">
            ...
            <tr>
                <td class="summary-label">Sale Channel</td>
                <td colspan="3">{{ $filters['sale_channel'] ?? 'all' }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table class="summary-table">
            <tr>
                ...
                <td class="summary-label">Total Sales Amount</td>
                <td>{{ $summary['total_sales_amount'] }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        @else
            <div class="empty">No confirmed sales found for the selected filters.</div>
        @endif
    </div>
</body>
</html>